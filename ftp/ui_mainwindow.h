...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        remoteFileSystem->setDragDropOverwriteMode(true);
        ...
        remoteFileSystem->setSortingEnabled(true);

        gridLayout_3->addWidget(remoteFileSystem, 1, 0, 1, 2);

        remoteHideFile = new QCheckBox(groupBox_2);
        remoteHideFile->setObjectName(QString::fromUtf8("remoteHideFile"));

        gridLayout_3->addWidget(remoteHideFile, 2, 0, 1, 1);
        ...
        localHideFile = new QCheckBox(groupBox_3);
        localHideFile->setObjectName(QString::fromUtf8("localHideFile"));

        gridLayout_4->addWidget(localHideFile, 2, 0, 1, 1);


        gridLayout_2->addWidget(groupBox_3, 1, 2, 1, 1);

        splitter->addWidget(layoutWidget);
        operationLog = new QPlainTextEdit(splitter);
        operationLog->setObjectName(QString::fromUtf8("operationLog"));
        operationLog->setMinimumSize(QSize(0, 0));
        operationLog->setBaseSize(QSize(0, 0));
        operationLog->setAcceptDrops(false);
        operationLog->setUndoRedoEnabled(false);
        operationLog->setReadOnly(true);
        splitter->addWidget(operationLog);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        remoteHideFile->setText(QCoreApplication::translate("MainWindow", "\344\270\215\346\230\276\347\244\272\351\232\220\350\227\217\346\226\207\344\273\266", nullptr));
        ...
        localHideFile->setText(QCoreApplication::translate("MainWindow", "\344\270\215\346\230\276\347\244\272\351\232\220\350\227\217\346\226\207\344\273\266", nullptr));
