...
SftpRealPath::SftpRealPath(SftpJobId jobId, const QString &path)
    : AbstractSftpOperation(jobId), path(path)
{
}
//added by whg,2020.4.1
SftpOutgoingPacket &SftpRealPath::initialPacket(SftpOutgoingPacket &packet)
{
    return packet.generateRealPath(path, jobId);
}
